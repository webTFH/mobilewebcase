contentMerch = '<meta charset="UTF-8">\
    <a href="%page%">\
    <div class="fl">\
    <p class="ptitle" style="color: #4a4a4a;font-weight: bolder">%merchName%</p>\
    <canvas data-src="%coverPath%" ></canvas>\
	<div style="bottom:20px;position: relative;">\
		<span style="color: red;background-color: white;left: 37px;position: relative;font-weight: bolder;\
		border-radius: 1px;">￥%price%</span>\
	</div>\
    <p class="bl" style="bottom:18px;position: relative">\
    	<span class="green" style="color: #cc7832">货道</span>\
    	<span class="green" >%rowId%</span></p>\
    </div>\
    </a>';
pagenumberGlobla0 = 0;
pagenumberGlobla1 = 0;
    ...
    return commonObj = {
        ...
        getData: function(pagenumber){
            ...
            if(window.location.href.indexOf("vm.html")!=-1){
                url = "http://oybmjmdba.bkt.clouddn.com/vm.json?v=5";
                pagenumberGlobla = pagenumberGlobla1;
                pagenumberGlobla1++;
            }else{
                url = "http://oybmjmdba.bkt.clouddn.com/index.json?v=5";
